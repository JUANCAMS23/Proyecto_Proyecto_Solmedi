    ...
    <div class="container">
        <footer class="py-3 my-4">
          <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item"><a href="http://localhost/Proyecto/pages/inicio_Solmedi.html?#" class="nav-link px-2 text-muted">INICIO</a></li>
            ...
            <p class="text-center text-muted">© 2023 MRMS, SA</p>
        </footer>
    </div>
