...
<div style="float: right; width: 80%; height: 100%;">
    ...
    <nav   class="navbar navbar-light bg-light" >
        <form class="d-flex" action="../php/buscarDatos.php" method="POST" >
    ...
    <table class="table table-bordered" >
            ...
            <tr>
              ...
              <td>
                <a href="../php/consultaHc_Solmedi.php?doc_paciente=<?php echo $mostrar['doc_paciente'];?>">
                ...
                <a href="../pages/editar_hc_Solmedi.php?doc_paciente=<?php echo $mostrar['doc_paciente'];?>">
...
<?php
include_once('../php/desplegable.php');
?>
